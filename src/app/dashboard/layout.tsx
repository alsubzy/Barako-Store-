  ...
  return (
    <div className="flex min-h-screen bg-[#FDFDFD] dark:bg-background transition-colors duration-300">
      ...
      <div className="flex-1 ml-64 transition-all duration-300 overflow-x-hidden">
        <header className="sticky top-0 z-40 flex h-20 items-center justify-between border-b border-slate-100 dark:border-slate-800 bg-white/80 dark:bg-background/80 px-10 backdrop-blur-xl">
          <div className="flex items-center gap-10">
            ...
            <div className="hidden lg:flex relative w-80">
              ...
              <Input 
                ...
                className="pl-11 h-10 bg-slate-100/50 dark:bg-background border-none rounded-xl text-xs font-bold focus-visible:ring-1 focus-visible:ring-primary/20 transition-all placeholder:text-slate-400" 
              />
            </div>
          </div>
